...
def showSelected():
    ...
    for val in valutes:
        ...
        plt.title("График построен для "+valname)
...
yearbutton=Button(ws, text="Установить даты для годового курса", bg="#00ff00", width=35, command=setYearDates).pack()
lastbutton=Button(ws, text="Установить даты прошлого запуска", bg="#00ff00", width=38, command=setLastDates).pack()
numbutton=Button(ws, text="Установить прошлое выделение", bg="#00ff00", width=50, command=selectLast).pack()
